-- 기장군 진학진로 지원센터 GitHub Pages + Supabase Auth/Edge Function용 스키마
...
--
-- insert into public.staff_profiles (auth_user_id, login_id, name, role)
-- values ('관리자_AUTH_USER_UUID', 'admin', '관리자', 'admin')
-- on conflict (auth_user_id) do update
-- set login_id = excluded.login_id, name = excluded.name, role = excluded.role, active = true, updated_at = now();
